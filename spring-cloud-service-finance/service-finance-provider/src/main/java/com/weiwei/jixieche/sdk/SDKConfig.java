 ...
 * =============================================================================
 */
package com.weiwei.jixieche.sdk;
...
public class SDKConfig {
	public static final String FILE_NAME = "unionpay/acp_sdk.properties";
	/** 前台请求URL. */
	...
	/** backUrl  */
	private String backUrl="https://api.app.vvjx.cn/finance/unionPay/notify";
