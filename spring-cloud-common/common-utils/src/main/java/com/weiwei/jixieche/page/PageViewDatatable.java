 ...
 * 封装分页信息逻辑的类
 */
public class PageViewDatatable<T> implements Serializable {
...
//    private int iTotalDisplayRecords;
	...
	public PageViewDatatable() {
	}

	//以页号模式的分页
	public PageViewDatatable(int pageNo, int pageSize) {
		this.pageNo = pageNo;
	...
	/*public PageViewDatatable(String iDisplayStart, String iDisplayLength) {
...
/*	public int getStartRowNo() {
	...
	public void setJqueryMode(boolean jqueryMode) {
		this.jqueryMode = jqueryMode;
	}*/
}
