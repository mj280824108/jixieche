...
@Data
@EqualsAndHashCode
@ApiModel(value="市场机械详情Vo")
public class MarketReleaseMachineDetailVo implements Serializable {
        ...
        * 0--未收藏,1--已收藏
        */
       public interface UserCollectionStatus{
              Integer UNCOLLECTION = 0;
